...
public class Main extends Thread {
    ...
    private MonitorResourceE monitorResourceE = new MonitorResourceE();
    ...
    class Thread extends java.lang.Thread {
        ...
        public void run() {
            ...
            int[][] MRi = utils.multMatrixMatrixValue(MS, MXi, di, Hi, Hip1);

            monitorResourceMR.setMR(MRi, Hi, Hip1);

            int[] Ei = monitorResourceE.getE();
            int mi = Integer.MAX_VALUE;

            mi = utils.multVectorMatrixAndMin(Ei, MM, Hi, Hip1, mi);
            ...
            MA = utils.addMatrixMatrix(
                    ...
                    utils.multMatrixMatrix(MO, monitorResourceMR.getMR(), Hi, Hip1), Hi, Hip1);
